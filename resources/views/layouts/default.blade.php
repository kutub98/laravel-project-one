...
<body>
  ...
  <div class="flex items-center justify-center flex-col w-full h-full text-gray-900 dark:text-gray-100 dark:bg-gray-950">
    <!-- Logo Section -->
    <div class="flex flex-col items-center mb-8">
      <div class=" aspect-video object-cover mx-auto">
        <img src="https://gmit.academy/app2/Image/GMIT%20LOGO1.png" class=" flex w-32 h-20  aspect-video object-contain animate-pulse" />
      </div>
    </div>
    ...
    <div class="flex flex-row gap-2 items-center space-y-4">
      <h1 class="text-xl md:text-3xl lg:text-4xl text-blue-800 font-bold flex items-center">
        L
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="animate-spin ml-2" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
